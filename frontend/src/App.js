  ...
  const theme = createTheme(
    {
      ...
      palette: {
        type: mode,
        primary: { main: mode === "light" ? "#f58d42" : "#FFFFFF" },
        textPrimary: mode === "light" ? "#fff" : "#FFFFFF",
        borderPrimary: mode === "light" ? "#fff" : "#FFFFFF",
        ...
        barraSuperior:
          mode === "light"
            ? "linear-gradient(to right, #f5a442, #f5a442 , #f5a442)"
            : "#f5a442",
