...
const MessagesAPI = () => {
  ...
  return (
    <Paper
      ...
      variant="outlined"
    >
      <Typography variant="h5">{i18n.t("messagesAPI.labels.doc")}</Typography>
      <Typography
        variant="h6"
        color="primary"
        className={classes.elementMargin}
      ...
      <Typography component="div">
        <ol>
          <li>{i18n.t("messagesAPI.labels.textMessage")}</li>
          <li>{i18n.t("messagesAPI.labels.mediaMessage")}</li>
        </ol>
      </Typography>
      <Typography
        variant="h6"
      ...
      <Typography className={classes.elementMargin} component="div">
        <b>{i18n.t("messagesAPI.labels.observations")}</b>
        <br />
        <ul>
          <li>
            {i18n.t("messagesAPI.labels.before1")} <br />
            {i18n.t("messagesAPI.labels.before2")}
          </li>
          <li>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Headers: </b> Authorization (Bearer token){" "}
            {i18n.t("messagesAPI.labels.e")} Content-Type (application/json){" "}
            <br />
            <b>Body: </b>{" "}
            {'{ "number": "5599999999999", "body": "Sua mensagem" }'}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>{i18n.t("messagesAPI.labels.method2")}: </b> POST <br />
            <b>Headers: </b> Authorization (Bearer token){" "}
            {i18n.t("messagesAPI.labels.e")} Content-Type (multipart/form-data){" "}
            <br />
            <b>FormData: </b> <br />
            <ul>
              <li>
